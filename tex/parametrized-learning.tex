...
We would like to thank Yann LeCun, Philip Stark, and Pierre Baldi for their feedback on the
project early in its conception and Bal\'azs K\'egl for discussions about the Kaggle challenge and 
non-standard loss functions. KC would like to thank in particular Alex Ihler for challenging discussions that 
led to a reformulation of the initial idea and Shimon Whiteson for patient feedback in that process. 
KC would also like to thank Yuri Shirman for reassuring discussions on elementary vector calculus.
