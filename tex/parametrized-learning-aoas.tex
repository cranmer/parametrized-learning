...
\runtitle{Approximating the Likelihood Ratio with Classifiers}
...
\affiliation{Center for Cosmology and Particle Physics\thanksmark{m1} 
       Center for Data Science\thanksmark{m2}
       New York University}
...
%Generalized likelihood ratio tests are used widely in HEP ~\cite{Cowan:2010js}, most notably in the discovery of the Higgs boson~\cite{Aad:2012tfa,Chatrchyan:2012ufa}.
